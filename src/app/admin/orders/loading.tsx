...
function TableSkeleton({ cols = 5, rows = 8 }: { cols?: number; rows?: number }) {
    return (
        <div className="admin-loading-table">
            ...
            {[...Array(rows)].map((_, i) => (
                <div key={i} className="admin-loading-table-row">
                    <div className="skeleton skeleton-cell-check" />
    ...
    return (
        <div className="admin-loading">
            ...
            <style>{`
                ...
                .skeleton-cell-check { width: 20px; height: 20px; border-radius: 4px; flex-shrink: 0; }
