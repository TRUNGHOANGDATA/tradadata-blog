        ...
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-card rounded-2xl border border-surface-200 dark:border-surface-700 p-5">
                        <h3 className="font-semibold text-fg mb-3">Chủ đề <span className="text-xs text-surface-400 font-normal">(chọn nhiều)</span></h3>
                    ...
                    <div className="bg-card rounded-2xl border border-surface-200 dark:border-surface-700 p-5">
                        <div className="flex items-center justify-between mb-3">
                            <h3 className="font-semibold text-fg">Ảnh bìa</h3>
                    ...
                    <div className="bg-card rounded-2xl border border-surface-200 dark:border-surface-700 p-5 space-y-4">
                        <div>
                        ...
                        <div className="border-t border-surface-200 dark:border-surface-700 pt-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="font-semibold text-fg">Ghim đầu trang</h3>
                                </div>
                                <button
                    ...
                    <div className="bg-card rounded-2xl border border-surface-200 dark:border-surface-700 p-5">
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="font-semibold text-fg">File Demo</h3>
                            </div>
                            {!showDemoFields && (
                                <button
