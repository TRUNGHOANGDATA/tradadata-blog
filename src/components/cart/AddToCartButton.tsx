...
export function AddToCartButton({ productId, productName, productPrice, productImage, className }: AddToCartButtonProps) {
    ...
    const handleAdd = () => {
        addToCart({ product_id: productId, name: productName, price: productPrice, image_url: productImage });
        setJustAdded(true);
